...
rl.question("What is the name of a real person?", function(answer){
    ...
    // ******************************************************
    // CAN USE A WRITABLE STREAM INSTEAD OF 'writeFileSync()'
    //*******************************************************

    // '.createWriteStream()' TAKES 1 ARG: THE PATH TO WRITE TO
    var stream = fs.createWriteStream("./lib/" + realPerson.name + ".md");

    // WE CAN NOW WRITE BITS OF TEXT TO THIS STREAM USING THE '.write()' METHOD
    ...
    rl.on('line', function(saying){
        ...
        if (saying.toLowerCase().trim() === 'exit') {
            ...
            // WE CAN NOW WRITE TO OUR FILE THROUGH OUR OPEN STREAM
            stream.write(`* ${saying} \n`);
